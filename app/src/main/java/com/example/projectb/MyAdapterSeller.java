...
public class MyAdapterSeller extends BaseAdapter {
    ...
    MyAdapterSeller(ArrayList <String> SellerName , ArrayList <String> SellerState , ArrayList <String> SellerImage , Context con ){
